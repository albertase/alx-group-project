...
const About: React.FC = () => {
    return (
        <div className="h-full">
            <h1 className="text-center py-28 md:pt-52 text-[#000000] Zilla_Slab sm:text-[40px] md:text-[58px] leading-[70px]">ELISHA ODEMAKINDE</h1>
            <div className="flex flex-col flex-wrap gap-12 rap p-8 md:flex-row md:flex-nowrap">
                <div className=" md:h-[755px] break-words w-full md:pl-12 overflow-x-hidden">
                    <p className="Montserrat text-[#1D1C1C] break-words w-full text-10 md:text-[20px] md:leading-[44.98px]">
                        ...
                        research / production innovation company based in lagos, Nigeria. <br/>
                ...
                <div className="bg-[#E0D5DD] w-full h-[755px] p-8 text-center">
                    <img src="/about_elisha.png" alt="About Elisha" className="w-[649px] h-[700.21px]"/>
                </div>
            </div>
        </div>
    )
