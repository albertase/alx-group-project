        ...
        <div className='grid bg-gray-100 grid-cols-1 py-24 sm:grid-cols-2 h-full w-full px-8'>
            ...
            <div className='bg-gray-100 flex flex-col justify-center'>
                <div className="text-[#1D1C1C] px-8 flex flex-col gap-6">
                    <h1 className="Zilla_Slab_contact text-[50px] leading-[60px]">Get in Touch !</h1>
                ...
                <form className='w-full mx-auto rounded-lg bg-gray-100 p-8 px-8'>
                    <div className='flex flex-col text-gray-400 py-2'>
                        <input className='rounded-lg mt-2 p-6 focus:outline-none border-2 border-[#C3C2D2]' type="text" placeholder="Full Name" />
                    </div>
                    <div className='flex flex-col text-gray-400 py-2'>
                        <input className='p-6 rounded-lg mt-2 focus:outline-none border-2 border-[#C3C2D2]' type="email" placeholder="Email Address"/>
                    </div>
                    <div className='flex flex-col text-gray-400 py-2'>
