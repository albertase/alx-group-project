  ...
  return (
    <div className="p-12 bg-gray-100">
      <div className='relative bg-gray-100 w-full h-[350px]'>
                <div className='absolute bg-[#E0D5DD] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-lg w-3/4 p-5 md:w-1/2 md:h-5/6 lg:w-1/2'>
